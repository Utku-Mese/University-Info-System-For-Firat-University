...
class UpdateLessonScreen extends StatefulWidget {
  const UpdateLessonScreen({super.key, required this.lesson});
...
class _UpdateLessonScreenState extends State<UpdateLessonScreen> {
  ...
  void initState() {
    ...
    isObligatory = widget.lesson.obligation == 1 ? true : false;
    nameController.text = widget.lesson.name!;
    shortNameController.text = widget.lesson.shortName!;
    creditController.text = widget.lesson.credit.toString();

    widget.lesson.instructor != null
        ? instructorController.text = widget.lesson.instructor!
        : instructorController.text = "";
    widget.lesson.descriptions != null
        ? descriptionController.text = widget.lesson.descriptions!
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "${widget.lesson.shortName} - ${widget.lesson.name}",
                        ...
                        try {
                          showTopSnackBar(
                            ...
                            CustomSnackBar.success(
                              message:
                                  "Lesson ${newLesson.shortName} - ${newLesson.name} updated successfully! Please refresh the page.",
                            ),
                          );
                          ...
                          showTopSnackBar(
                            ...
                            const CustomSnackBar.error(
                              message: "An error occured while updated lesson!",
                            ),
                          );
                          debugPrint('Hata: $e');
                        }
